""" Head2Head V0.74 - March 2023 by Steve Shambles.

    Historical data supplied by https://football-data.co.uk, with thanks.
    Current data covers Aug 1992 to March 14th 2023.
...
def predict_outcome():
    ...
    msg_lab.config(bg='powderblue', text='Matches: ' + str(total_results) +
    ...
    msg_lab2.config(bg='powderblue', text='Avg Home Goals: ' +
    ...
    msg_lab3.config(bg='powderblue',
                    text='Based solely on these results, the next '
                    'predicted outcome of this fixture is: '
    ...
    'Avg Away Goals:' + str(Fs.away_avg_goals) + '\n\n'  \
    'Based solely on these results, the next predicted outcome '  \
